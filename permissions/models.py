...
class Permission(models.Model):
    ...
    **Attributes:**
    ...
    content_types = models.ManyToManyField(ContentType, verbose_name=_("Content Types"), blank=True, null=True,
...
class Role(models.Model):
    ...
    **Attributes:**
    ...
    codename = models.CharField(_("Codename"), max_length=100, unique=True)
    global_permissions = models.ManyToManyField(Permission, verbose_name=_("Global permissions"),
...
class PrincipalRoleRelation(models.Model):
    ...
    content_type = models.ForeignKey(ContentType, verbose_name=_("Content type"), blank=True, null=True, on_delete=models.CASCADE)
